package com.ms.user.UserService.config;

import com.ms.user.UserService.config.interceptor.RestTempletInterceptor;
...
public class Configuration {
    ...
    public RestTemplate restTemplate(){
        ...
        interceptor.add(new RestTempletInterceptor(manager(clientRegistrationRepository,oAuth2AuthorizedClientRepository)));
